...
def get_mask_card_number(card_number: str) -> str:
    ...
    replacement = r"\1 \2** **** \4"
    logger.info('Маскировка номера карты: модуль "%s", функция "%s"', __name__, get_mask_card_number.__name__)
...
def get_mask_account(account_data: str) -> str:
    ...
    """
    logger.info('Маскировка банковского счёта: модуль "%s", функция "%s"', __name__, get_mask_account.__name__)
